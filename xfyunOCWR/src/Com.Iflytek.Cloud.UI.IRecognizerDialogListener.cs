...
namespace Com.Iflytek.Cloud.UI {
	...
	public partial interface IRecognizerDialogListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onError", "(Lcom/iflytek/cloud/SpeechError;)V", "GetOnError_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.UI.IRecognizerDialogListenerInvoker, xfyunOCWR")]
		...
		[Register ("onResult", "(Lcom/iflytek/cloud/RecognizerResult;Z)V", "GetOnResult_Lcom_iflytek_cloud_RecognizerResult_ZHandler:Com.Iflytek.Cloud.UI.IRecognizerDialogListenerInvoker, xfyunOCWR")]
	...
	internal partial class IRecognizerDialogListenerInvoker : global::Java.Lang.Object, IRecognizerDialogListener {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.ui.RecognizerDialogListener"));
			return handle;
		}
...
#pragma warning restore 0169
	...
	internal sealed partial class IRecognizerDialogListenerImplementor : global::Java.Lang.Object, IRecognizerDialogListener {
		...
		public IRecognizerDialogListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/ui/RecognizerDialogListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
		{
