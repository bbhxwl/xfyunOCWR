...
namespace Com.Iflytek.Cloud.Util {
	...
	public abstract partial class ContactManager : global::Java.Lang.Object {
		...
		public partial interface IContactListener : IJavaObject, IJavaPeerable {
			...
			[Register ("onContactQueryFinish", "(Ljava/lang/String;Z)V", "GetOnContactQueryFinish_Ljava_lang_String_ZHandler:Com.Iflytek.Cloud.Util.ContactManager/IContactListenerInvoker, xfyunOCWR")]
		...
		internal partial class IContactListenerInvoker : global::Java.Lang.Object, IContactListener {
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.util.ContactManager.ContactListener"));
				return handle;
			}
...
#pragma warning restore 0169
		...
		internal sealed partial class IContactListenerImplementor : global::Java.Lang.Object, IContactListener {
			...
			public IContactListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/util/ContactManager_ContactListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
			{
		...
		[Register (".ctor", "()V", "")]
		protected unsafe ContactManager () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
