...
namespace Com.Iflytek.Cloud.Msc.Ist {
	...
	public partial class AudioAccessor : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		protected unsafe AudioAccessor () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		protected unsafe AudioAccessor (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		protected unsafe AudioAccessor (string p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
