...
namespace Com.Iflytek.Cloud.Record {
	...
	public partial class PcmRecorder : global::Java.Lang.Thread {
		...
		public partial interface IPcmRecordListener : IJavaObject, IJavaPeerable {
			...
			[Register ("onError", "(Lcom/iflytek/cloud/SpeechError;)V", "GetOnError_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.Record.PcmRecorder/IPcmRecordListenerInvoker, xfyunOCWR")]
			...
			[Register ("onRecordBuffer", "([BII)V", "GetOnRecordBuffer_arrayBIIHandler:Com.Iflytek.Cloud.Record.PcmRecorder/IPcmRecordListenerInvoker, xfyunOCWR")]
			...
			[Register ("onRecordReleased", "()V", "GetOnRecordReleasedHandler:Com.Iflytek.Cloud.Record.PcmRecorder/IPcmRecordListenerInvoker, xfyunOCWR")]
			...
			[Register ("onRecordStarted", "(Z)V", "GetOnRecordStarted_ZHandler:Com.Iflytek.Cloud.Record.PcmRecorder/IPcmRecordListenerInvoker, xfyunOCWR")]
		...
		internal partial class IPcmRecordListenerInvoker : global::Java.Lang.Object, IPcmRecordListener {
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.record.PcmRecorder.PcmRecordListener"));
				return handle;
			}
...
#pragma warning restore 0169
		...
		internal sealed partial class IPcmRecordListenerImplementor : global::Java.Lang.Object, IPcmRecordListener {
			...
			public IPcmRecordListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/record/PcmRecorder_PcmRecordListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
			{
		...
		[Register (".ctor", "(II)V", "")]
		public unsafe PcmRecorder (int p0, int p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		[Register (".ctor", "(III)V", "")]
		public unsafe PcmRecorder (int p0, int p1, int p2) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
