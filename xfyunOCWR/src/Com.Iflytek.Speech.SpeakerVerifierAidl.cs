...
namespace Com.Iflytek.Speech {
	...
	public partial class SpeakerVerifierAidl : global::Java.Lang.Object {
		...
		public partial interface IDownloadListener : IJavaObject, IJavaPeerable {
			...
			[Register ("onData", "(Ljava/util/ArrayList;)V", "GetOnData_Ljava_util_ArrayList_Handler:Com.Iflytek.Speech.SpeakerVerifierAidl/IDownloadListenerInvoker, xfyunOCWR")]
			...
			[Register ("onError", "(I)V", "GetOnError_IHandler:Com.Iflytek.Speech.SpeakerVerifierAidl/IDownloadListenerInvoker, xfyunOCWR")]
			void OnError (int p0);
		...
		internal partial class IDownloadListenerInvoker : global::Java.Lang.Object, IDownloadListener {
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.speech.SpeakerVerifierAidl.DownloadListener"));
				return handle;
			}
...
#pragma warning restore 0169
		...
		internal sealed partial class IDownloadListenerImplementor : global::Java.Lang.Object, IDownloadListener {
			...
			public IDownloadListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/speech/SpeakerVerifierAidl_DownloadListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
			{
		...
		public partial class PassWord : global::Java.Lang.Object {
			...
			public unsafe PassWord (global::Com.Iflytek.Speech.SpeakerVerifierAidl __self) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
		...
		public unsafe SpeakerVerifierAidl (global::Android.Content.Context p0, global::Com.Iflytek.Cloud.IInitListener p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
