...
namespace Com.Iflytek.Cloud.Binbin6{
	...
	public partial interface ISynthesizerListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onBufferProgress", "(IIILjava/lang/String;)V", "GetOnBufferProgress_IIILjava_lang_String_Handler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onCompleted", "(Lcom/iflytek/cloud/SpeechError;)V", "GetOnCompleted_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onEvent", "(IIILandroid/os/Bundle;)V", "GetOnEvent_IIILandroid_os_Bundle_Handler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onSpeakBegin", "()V", "GetOnSpeakBeginHandler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		void OnSpeakBegin ();
		...
		[Register ("onSpeakPaused", "()V", "GetOnSpeakPausedHandler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		void OnSpeakPaused ();
		...
		[Register ("onSpeakProgress", "(III)V", "GetOnSpeakProgress_IIIHandler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onSpeakResumed", "()V", "GetOnSpeakResumedHandler:Com.Iflytek.Cloud.ISynthesizerListenerInvoker, xfyunOCWR")]
		void OnSpeakResumed ();
	...
	internal partial class ISynthesizerListenerInvoker : global::Java.Lang.Object, ISynthesizerListener {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.SynthesizerListener"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Iflytek.Cloud.Binbin6.ISynthesizerListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
	...
	internal sealed partial class ISynthesizerListenerImplementor : global::Java.Lang.Object, ISynthesizerListener {
		...
		public ISynthesizerListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/SynthesizerListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
		{
