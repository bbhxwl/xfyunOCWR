...
namespace Com.Iflytek.Speech {
	...
	public partial interface ISpeechModule : IJavaObject, IJavaPeerable {
		global::Android.Content.Intent Intent {
			...
			[Register ("getIntent", "()Landroid/content/Intent;", "GetGetIntentHandler:Com.Iflytek.Speech.ISpeechModuleInvoker, xfyunOCWR")]
			get; 
		}
		...
		bool IsAvailable {
			...
			[Register ("isAvailable", "()Z", "GetIsAvailableHandler:Com.Iflytek.Speech.ISpeechModuleInvoker, xfyunOCWR")]
			get; 
		}
		...
		[Register ("destory", "()Z", "GetDestoryHandler:Com.Iflytek.Speech.ISpeechModuleInvoker, xfyunOCWR")]
		bool Destory ();
		...
		[Register ("getParameter", "(Ljava/lang/String;)Ljava/lang/String;", "GetGetParameter_Ljava_lang_String_Handler:Com.Iflytek.Speech.ISpeechModuleInvoker, xfyunOCWR")]
		...
		[Register ("setParameter", "(Ljava/lang/String;Ljava/lang/String;)I", "GetSetParameter_Ljava_lang_String_Ljava_lang_String_Handler:Com.Iflytek.Speech.ISpeechModuleInvoker, xfyunOCWR")]
	...
	internal partial class ISpeechModuleInvoker : global::Java.Lang.Object, ISpeechModule {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.speech.ISpeechModule"));
			return handle;
		}
