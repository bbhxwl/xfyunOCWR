...
namespace Com.Iflytek.Cloud.Binbin3 {
	...
	public partial interface IRecognizerListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onBeginOfSpeech", "()V", "GetOnBeginOfSpeechHandler:Com.Iflytek.Cloud.IRecognizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onEndOfSpeech", "()V", "GetOnEndOfSpeechHandler:Com.Iflytek.Cloud.IRecognizerListenerInvoker, xfyunOCWR")]
		void OnEndOfSpeech ();
		...
		[Register ("onError", "(Lcom/iflytek/cloud/SpeechError;)V", "GetOnError_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.IRecognizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onEvent", "(IIILandroid/os/Bundle;)V", "GetOnEvent_IIILandroid_os_Bundle_Handler:Com.Iflytek.Cloud.IRecognizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onResult", "(Lcom/iflytek/cloud/RecognizerResult;Z)V", "GetOnResult_Lcom_iflytek_cloud_RecognizerResult_ZHandler:Com.Iflytek.Cloud.IRecognizerListenerInvoker, xfyunOCWR")]
		...
		[Register ("onVolumeChanged", "(I[B)V", "GetOnVolumeChanged_IarrayBHandler:Com.Iflytek.Cloud.IRecognizerListenerInvoker, xfyunOCWR")]
	...
	internal partial class IRecognizerListenerInvoker : global::Java.Lang.Object, IRecognizerListener {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.RecognizerListener"));
			return handle;
		}
...
#pragma warning disable 0169
		...
		{
			var __this = global::Java.Lang.Object.GetObject<global::Com.Iflytek.Cloud.Binbin3.IRecognizerListener> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
	...
	// event args for com.iflytek.cloud.RecognizerListener.onEvent
	...
	internal sealed partial class IRecognizerListenerImplementor : global::Java.Lang.Object, IRecognizerListener {
		...
		public IRecognizerListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/RecognizerListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
		{
