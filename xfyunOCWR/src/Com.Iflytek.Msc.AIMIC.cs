...
namespace Com.Iflytek.Msc {
	...
	public partial class AIMIC : global::Java.Lang.Object {
		...
		public partial interface IListener : IJavaObject, IJavaPeerable {
			...
			[Register ("onRecogAudio", "([BIILjava/lang/Object;)V", "GetOnRecogAudio_arrayBIILjava_lang_Object_Handler:Com.Iflytek.Msc.AIMIC/IListenerInvoker, xfyunOCWR")]
			...
			[Register ("onWakeupAudio", "([BIILjava/lang/Object;)V", "GetOnWakeupAudio_arrayBIILjava_lang_Object_Handler:Com.Iflytek.Msc.AIMIC/IListenerInvoker, xfyunOCWR")]
			...
			[Register ("onWakeupMsg", "(III[BI[BI[BI)V", "GetOnWakeupMsg_IIIarrayBIarrayBIarrayBIHandler:Com.Iflytek.Msc.AIMIC/IListenerInvoker, xfyunOCWR")]
		...
		internal partial class IListenerInvoker : global::Java.Lang.Object, IListener {
			...
			static IntPtr Validate (IntPtr handle)
			{
				if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
					throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.msc.AIMIC.Listener"));
				return handle;
			}
...
#pragma warning restore 0169
		...
		internal sealed partial class IListenerImplementor : global::Java.Lang.Object, IListener {
			...
			public IListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/msc/AIMIC_ListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
			{
		...
		[Register (".ctor", "()V", "")]
		public unsafe AIMIC () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
