...
namespace Com.Iflytek.Cloud.Util {
	...
	public abstract partial class AudioDetector : global::Java.Lang.Object {
		...
		public partial class DetectorResult : global::Java.Lang.Object {
			...
			[Register (".ctor", "()V", "")]
			public unsafe DetectorResult () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
			{
				const string __id = "()V";
		...
		protected unsafe AudioDetector (global::Android.Content.Context p0, string p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
