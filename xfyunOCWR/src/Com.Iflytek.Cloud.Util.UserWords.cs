...
namespace Com.Iflytek.Cloud.Util {
	...
	public partial class UserWords : global::Java.Lang.Object {
		...
		[Register (".ctor", "()V", "")]
		public unsafe UserWords () : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			const string __id = "()V";
		...
		public unsafe UserWords (string p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
