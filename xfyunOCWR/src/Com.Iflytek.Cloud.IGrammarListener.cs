...
namespace Com.Iflytek.Cloud {
	...
	public partial interface IGrammarListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onBuildFinish", "(Ljava/lang/String;Lcom/iflytek/cloud/SpeechError;)V", "GetOnBuildFinish_Ljava_lang_String_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.IGrammarListenerInvoker, xfyunOCWR")]
	...
	internal partial class IGrammarListenerInvoker : global::Java.Lang.Object, IGrammarListener {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.GrammarListener"));
			return handle;
		}
...
#pragma warning restore 0169
	...
	internal sealed partial class IGrammarListenerImplementor : global::Java.Lang.Object, IGrammarListener {
		...
		public IGrammarListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/GrammarListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
		{
