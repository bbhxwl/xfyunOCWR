...
namespace Com.Iflytek.Cloud.Util {
	...
	public partial interface IFileDownloadListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onCompleted", "(Ljava/lang/String;Lcom/iflytek/cloud/SpeechError;)V", "GetOnCompleted_Ljava_lang_String_Lcom_iflytek_cloud_SpeechError_Handler:Com.Iflytek.Cloud.Util.IFileDownloadListenerInvoker, xfyunOCWR")]
		...
		[Register ("onProgress", "(I)V", "GetOnProgress_IHandler:Com.Iflytek.Cloud.Util.IFileDownloadListenerInvoker, xfyunOCWR")]
		...
		[Register ("onStart", "()V", "GetOnStartHandler:Com.Iflytek.Cloud.Util.IFileDownloadListenerInvoker, xfyunOCWR")]
		void OnStart ();
	...
	internal partial class IFileDownloadListenerInvoker : global::Java.Lang.Object, IFileDownloadListener {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.util.FileDownloadListener"));
			return handle;
		}
...
#pragma warning restore 0169
	...
	internal sealed partial class IFileDownloadListenerImplementor : global::Java.Lang.Object, IFileDownloadListener {
		...
		public IFileDownloadListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/util/FileDownloadListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
		{
