...
namespace Com.Iflytek.Cloud {
	...
	public partial class SpeechError : global::Java.Lang.Exception {
		...
		[Register (".ctor", "(I)V", "")]
		public unsafe SpeechError (int p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe SpeechError (int p0, string p1) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
		...
		public unsafe SpeechError (global::Java.Lang.Exception p0) : base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
