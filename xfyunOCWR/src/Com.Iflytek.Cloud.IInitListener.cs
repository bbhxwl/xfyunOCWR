...
namespace Com.Iflytek.Cloud {
	...
	public partial interface IInitListener : IJavaObject, IJavaPeerable {
		...
		[Register ("onInit", "(I)V", "GetOnInit_IHandler:Com.Iflytek.Cloud.IInitListenerInvoker, xfyunOCWR")]
		void OnInit (int p0);
	...
	internal partial class IInitListenerInvoker : global::Java.Lang.Object, IInitListener {
		...
		static IntPtr Validate (IntPtr handle)
		{
			if (!JNIEnv.IsInstanceOf (handle, java_class_ref))
				throw new InvalidCastException (string.Format ("Unable to convert instance of type '{0}' to type '{1}'.", JNIEnv.GetClassNameFromInstance (handle), "com.iflytek.cloud.InitListener"));
			return handle;
		}
...
#pragma warning restore 0169
	...
	internal sealed partial class IInitListenerImplementor : global::Java.Lang.Object, IInitListener {
		...
		public IInitListenerImplementor (object sender) : base (global::Android.Runtime.JNIEnv.StartCreateInstance ("mono/com/iflytek/cloud/InitListenerImplementor", "()V"), JniHandleOwnership.TransferLocalRef)
		{
